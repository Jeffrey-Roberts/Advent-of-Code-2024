...
public class Solution {
    public static int sumValidPagesMiddleValue(String input) {
        ...
        List<List<Integer>> validPagesToProduce = pagesToProduce.stream().filter(pages -> isValidOrder(pages, orderingRules)).toList();
    ...
    private static int sumMiddlePages(List<List<Integer>> pagesToProduce) {
        int total = 0;
        for (List<Integer> pages : pagesToProduce) total += pages.get(pages.size() / 2);
        return total;
    }
